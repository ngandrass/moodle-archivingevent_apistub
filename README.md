# Moodle Archiving Event Connector: API Stub

Stub external event adapter for the [Moodle archiving subsystem](https://github.com/ngandrass/moodle-local_archiving/).
...
External event connectors (`archivingevent`) are sub-plugins of the archiving subsystem core (`local_archiving`) and
